<template>
  <el-menu class="el-menu-vertical-demo" :collapse="isCollapse" text-color="black" background-color="rgb(247,246,242)"
    ...
    <div class="platform">
      <img class="platform-logo" :src="require('@/assets/image/logo/80.png')" alt="logo" @click="goTest">
      <div v-if="!isCollapse" id="platform-title">
        <a class="platform-title" @click="goShow">PP-GeoView遥感解译</a>
      </div>
    </div>
    <el-divider content-position="center">
      <span v-show="!isCollapse" class="divider-title">功能区</span>
    </el-divider>
    <el-menu-item  index="/test" @click="goTest">
    ...
    <el-menu-item  index="/test2" @click="goTest2">
    ...
    <el-menu-item  index="/test3" @click="goTest3">
    ...
    <el-menu-item  index="/test4" @click="goTest4">
...
<script>
import {
  goTest,goTest2,goTest3,goTest4
